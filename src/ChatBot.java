public class ChatBot {
    ...
    // method that divides and returns the quotient of 2 numbers
    public int divNumbers(int num3, int num4) {
        return num3 / num4;
    }

    // method that prints information about favorite foods.
    public void favoriteFood(String yourFood) {
        System.out.println("I actually can't have food but cake looks really yummy!");
        System.out.println("Your favorite food, " + yourFood + ", looks yummy too!");
    }
}
